...
RSpec.describe Food, type: :model do
  ...
  describe 'associations' do
    ...
    it 'has many recipe_foods' do
      ...
      recipe_food1 = RecipeFood.create(food: food, recipe: @recipe)
      recipe_food2 = RecipeFood.create(food: food, recipe: @recipe)
    ...
    it 'destroys associated recipe_foods when destroyed' do
      food = Food.create(name: 'Chicken', measurement_unit: 'kg', user: @user1)
      recipe_food = RecipeFood.create(food: food, recipe: @recipe)
